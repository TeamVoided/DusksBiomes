...
object StructureProcessorCreator {
    ...
    fun bootstrap(context: BootstrapContext<StructureProcessorList>) {
        ...
        val structureProcessorRule = StructureProcessorRule(
            RandomBlockMatchRuleTest(Blocks.BLACKSTONE, 0.01f),
            AlwaysTrueRuleTest.INSTANCE,
            Blocks.GILDED_BLACKSTONE.defaultState
        )
        val structureProcessorRule2 = StructureProcessorRule(
            RandomBlockMatchRuleTest(Blocks.GILDED_BLACKSTONE, 0.5f),
            AlwaysTrueRuleTest.INSTANCE,
