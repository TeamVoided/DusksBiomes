...
import org.teamvoided.dusks_biomes.datagen.data.worldgen.biome.CavesCreator.createPaleUndergarden
...
object BiomeCreator {
    ...
    fun boostrap(c: BootstrapContext<Biome>) {
        ...
        c.register(DuskBiomes.PALE_UNDERGARDEN, c.createPaleUndergarden())
    }
